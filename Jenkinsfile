  ...
  stage("Build") {
   ...
   parallel (
     "Linux64" : {
       ...
       sh "zip -9 OVDNativeClient_linux64.zip OVDNativeClient_linux64"
     },
     "Linux32" : {
       ...
       sh "zip -9 OVDNativeClient_linux32.zip OVDNativeClient_linux32"
     ...
     "Windows64" : {
       ...
       sh "zip -9 OVDNativeClient_Windows64.zip OVDNativeClient_Windows64"
     },
     "Windows32" : {
       ...
       sh "zip -9 OVDNativeClient_Windows32.zip OVDNativeClient_Windows32"
       },
     "Mac" : {
       ...
       sh "zip -9 OVDNativeClient_mac.zip OVDNativeClient_mac"
